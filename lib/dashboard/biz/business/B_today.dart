...
class BToday extends StatefulWidget {
  @override
  _BTodayState createState() => _BTodayState();
}

class _BTodayState extends State<BToday> {
        ...
        body: CustomScrollView(slivers: <Widget>[
          SliverAppBar(
            ...
            flexibleSpace: TxnAmount(title:"Today's earnings".toUpperCase() ,
              amount: DateTime.now().day ==    Constant1.workingDocuments![0]['day']?'${VariablesOne.numberFormat.format(  Constant1.workingDocuments![0]['p1d']).toString()}':'0.00',
                              ...
                              children: <Widget>[
                                Row(
                                  ...
                                  type: ''.toString(),
                                    ...
                                    itemsData[index]['by'] == true?
                                    AmountOrders( gas: itemsData[index]['amt'],amount: itemsData[index]['p1'],mop: itemsData[index]['mp'] ,)
                                        :
                                    itemsData[index]['acy'] == null? AmountOrders( gas: itemsData[index]['aG'],amount: itemsData[index]['p1'],mop: itemsData[index]['mp'] ,)
                                        :AmountOrderNew(
                                      gas: itemsData[index]['aG'],
                                      cye: itemsData[index]['py1'],
                                      cylinder: itemsData[index]['acy'],
                                      amount: itemsData[index]['p1'],
                                      mop: itemsData[index]['mp'],
                                      total: itemsData[index]['py1'] + itemsData[index]['p1'],
                                    )
...
.collection("vendorDaily").where(
        'cbi', isEqualTo: Variables.userUid)
