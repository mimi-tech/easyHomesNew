...
class BMonth extends StatefulWidget {
  @override
  _BMonthState createState() => _BMonthState();
}

class _BMonthState extends State<BMonth> {
    ...
    return SafeArea(child: Scaffold(
        ...
        body: CustomScrollView(slivers: <Widget>[
          ...
          SliverAppBar(
              ...
              flexibleSpace: TxnAmount(title:"This Month earnings".toUpperCase() ,
                orderCount: DateTime.now().month ==   Constant1.workingDocuments![0]['mth']?  Constant1.workingDocuments![0]['mtb'].toString():'0',
                amount:  DateTime.now().month ==   Constant1.workingDocuments![0]['mth']?'${VariablesOne.numberFormat.format(  Constant1.workingDocuments![0]['p1m']).toString()}':'0.00',
              )),
          SliverAppBar(
            ...
            flexibleSpace:BizPeriod(title: kMonthly,),),
          SliverList(
