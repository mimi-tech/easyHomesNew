...
class BWeek extends StatefulWidget {
  @override
  _BWeekState createState() => _BWeekState();
}

class _BWeekState extends State<BWeek> {
        ...
        body: CustomScrollView(slivers: <Widget>[
          ...
          SliverAppBar(
              ...
              flexibleSpace: TxnAmount(title:"This Week earnings".toUpperCase() ,
                ...
                amount:  Jiffy().week ==   Constant1.workingDocuments![0]['wky']?'${VariablesOne.numberFormat.format(  Constant1.workingDocuments![0]['p1w']).toString()}':'0.00',
              )),
          ...
          SliverAppBar(
            ...
            flexibleSpace:BizPeriod(title: kWeekly,),),
          SliverList(
