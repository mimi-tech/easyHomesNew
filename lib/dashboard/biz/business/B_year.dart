...
class BYear extends StatefulWidget {
  @override
  _BYearState createState() => _BYearState();
}

class _BYearState extends State<BYear> {
        ...
        body: CustomScrollView(slivers: <Widget>[
          ...
          SliverAppBar(
              ...
              flexibleSpace: TxnAmount(title:"This Year earnings".toUpperCase() ,
                ...
                amount:  DateTime.now().year ==   Constant1.workingDocuments![0]['yr']?'${VariablesOne.numberFormat.format(  Constant1.workingDocuments![0]['p1y']).toString()}':'0.00',
              )),
          SliverAppBar(
            ...
            flexibleSpace:BizPeriod(title: kYearly,),),
          SliverList(
