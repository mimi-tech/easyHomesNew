...
class PartnerEarnings extends StatefulWidget {
  @override
  _PartnerEarningsState createState() => _PartnerEarningsState();
}

class _PartnerEarningsState extends State<PartnerEarnings> {
              ...
              children: <Widget>[
                ...
                StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
                    stream: FirebaseFirestore.instance
                        ...
                        .where('pd', isEqualTo: Variables.userUid).snapshots(),
                                    ...
                                    child: Column(
                                      children: <Widget>[
                                              ...
                                              children: <Widget>[
                                                ...
                                                MoneyFormatColors(
                                                  ...
                                                  title: TextWidgetAlign(
                                                    name: '${VariablesOne.numberFormat.format(workingDocuments[index]['p2y']).toString()}',
                                        ...
                                        EarningsConstruct(period: kToday,
                                          ...
                                          title: DateTime.now().day == workingDocuments[index]['day']?'${VariablesOne.numberFormat.format(workingDocuments[index]['p2d']).toString()}':'0.00',
                                          open: (){
                                            Navigator.push(context, PageTransition(
                                                type: PageTransitionType.rightToLeft,
                                                child: PToday()));
                                        ...
                                        EarningsConstruct(period: kWeekly,
                                          ...
                                          title: Jiffy().week == workingDocuments[index]['wky']?'${VariablesOne.numberFormat.format(workingDocuments[index]['p2w']).toString()}':'0.00',
                                          open: (){
                                            Navigator.push(context, PageTransition(
                                                type: PageTransitionType.rightToLeft,
                                                child: PWeek()));
                                        ...
                                        EarningsConstruct(period: kMonthly,
                                          ...
                                          title: DateTime.now().month == workingDocuments[index]['mth']?'${VariablesOne.numberFormat.format(workingDocuments[index]['p2m']).toString()}':'0.00',
                                          open: (){
                                            Navigator.push(context, PageTransition(
                                                type: PageTransitionType.rightToLeft,
                                                child: PMonth()));
                                        ...
                                        EarningsConstruct(period: kYearly,
                                          ...
                                          title: DateTime.now().year == workingDocuments[index]['yr']?'${VariablesOne.numberFormat.format(workingDocuments[index]['p2y']).toString()}':'0.00',
