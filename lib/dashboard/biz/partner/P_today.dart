...
class PToday extends StatefulWidget {
  @override
  _PTodayState createState() => _PTodayState();
}

class _PTodayState extends State<PToday> {
        ...
        body: CustomScrollView(slivers: <Widget>[
          ...
          SliverAppBar(
              ...
              flexibleSpace: TxnAmount(title:"Today's earnings".toUpperCase() ,
                amount: DateTime.now().day ==    Constant1.workingDocuments![0]['day']?'${VariablesOne.numberFormat.format(  Constant1.workingDocuments![0]['p2d']).toString()}':'0.00',
