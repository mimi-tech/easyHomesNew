...
class OYear extends StatefulWidget {
  @override
  _OYearState createState() => _OYearState();
}

class _OYearState extends State<OYear> {
        ...
        body: CustomScrollView(slivers: <Widget>[
          ...
          SliverAppBar(
              ...
              flexibleSpace: TxnAmount(title:"This Year earnings".toUpperCase() ,
                ...
                amount:  DateTime.now().year ==   Constant1.workingDocuments![0]['yr']?'${VariablesOne.numberFormat.format(  Constant1.workingDocuments![0]['p3y']).toString()}':'0.00',
              )),
          SliverAppBar(
