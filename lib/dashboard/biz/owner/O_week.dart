...
class OWeek extends StatefulWidget {
  @override
  _OWeekState createState() => _OWeekState();
}

class _OWeekState extends State<OWeek> {
        ...
        body: CustomScrollView(slivers: <Widget>[
          ...
          SliverAppBar(
              ...
              flexibleSpace: TxnAmount(title:"This Week earnings".toUpperCase() ,
                ...
                amount:  Jiffy().week ==   Constant1.workingDocuments![0]['wky']?'${VariablesOne.numberFormat.format(  Constant1.workingDocuments![0]['p3w']).toString()}':'0.00',
              )),
