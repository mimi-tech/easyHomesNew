...
class OMonth extends StatefulWidget {
  @override
  _OMonthState createState() => _OMonthState();
}

class _OMonthState extends State<OMonth> {
        ...
        body: CustomScrollView(slivers: <Widget>[
          ...
          SliverAppBar(
              ...
              flexibleSpace: TxnAmount(title:"This Month earnings".toUpperCase() ,
                ...
                amount:  DateTime.now().month ==   Constant1.workingDocuments![0]['mth']?'${VariablesOne.numberFormat.format(  Constant1.workingDocuments![0]['p3m']).toString()}':'0.00',
              )),
