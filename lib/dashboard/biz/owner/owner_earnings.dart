...
class OwnerEarnings extends StatefulWidget {
  @override
  _OwnerEarningsState createState() => _OwnerEarningsState();
}

class _OwnerEarningsState extends State<OwnerEarnings> {
              ...
              children: <Widget>[
                ...
                StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
                    stream: FirebaseFirestore.instance
                        ...
                        .where('od', isEqualTo: Variables.userUid).snapshots(),
                    builder: (context, snapshot) {
                      ...
                      return ErrorTitle(errorTitle: kNoBooking,);
                      }else{
                        ...
                        return workingDocuments.length == 0
                            ? Center(child: ErrorTitle(errorTitle: kNoBooking,))
                            : ListView.builder(
                                    ...
                                    child: Column(
                                      children: <Widget>[
                                              ...
                                              children: <Widget>[
                                                ...
                                                MoneyFormatColors(
                                                  ...
                                                  title: TextWidgetAlign(
                                                    name: '${VariablesOne.numberFormat.format(workingDocuments[index]['p3y']).toString()}',
                                        ...
                                        EarningsConstruct(period: kToday,
                                          ...
                                          title: DateTime.now().day == workingDocuments[index]['day']?'${VariablesOne.numberFormat.format(workingDocuments[index]['p3d']).toString()}':'0.00',
                                          open: (){
                                            Navigator.push(context, PageTransition(
                                                type: PageTransitionType.rightToLeft,
                                                child: OToday()));
                                        ...
                                        EarningsConstruct(period: kWeekly,
                                          ...
                                          title: Jiffy().week == workingDocuments[index]['wky']?'${VariablesOne.numberFormat.format(workingDocuments[index]['p3w']).toString()}':'0.00',
                                          open: (){
                                            Navigator.push(context, PageTransition(
                                                type: PageTransitionType.rightToLeft,
                                                child: OWeek()));
                                        ...
                                        EarningsConstruct(period: kMonthly,
                                          ...
                                          title: DateTime.now().month == workingDocuments[index]['mth']?'${VariablesOne.numberFormat.format(workingDocuments[index]['p3m']).toString()}':'0.00',
                                          open: (){
                                            Navigator.push(context, PageTransition(
                                                type: PageTransitionType.rightToLeft,
                                                child: OMonth()));
                                        ...
                                        EarningsConstruct(period: kYearly,
                                          ...
                                          title: DateTime.now().year == workingDocuments[index]['yr']?'${VariablesOne.numberFormat.format(workingDocuments[index]['p3y']).toString()}':'0.00',
