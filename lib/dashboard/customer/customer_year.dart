...
class CustomerYear extends StatefulWidget {
  @override
  _CustomerYearState createState() => _CustomerYearState();
}

class _CustomerYearState extends State<CustomerYear> {
                    ...
                    children: <Widget>[
                      Row(
                        ...
                        children: <Widget>[
                          ...
                          AmountOrders( amount: itemsData[index]['amt'],mop: itemsData[index]['mp'], gas: '' ,),
