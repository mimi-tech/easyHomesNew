...
class DWTransaction extends StatefulWidget {
  @override
  _DWTransactionState createState() => _DWTransactionState();
}

class _DWTransactionState extends State<DWTransaction> {
  ...
  Future<void> getDailyBooking() async {
    final QuerySnapshot result = await FirebaseFirestore.instance
        ...
        .where('dpp', isEqualTo: kDeposit)
        .where('dpw', isEqualTo: kWith)
