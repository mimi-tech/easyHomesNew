...
class DashBoardStatusTab extends StatefulWidget {


  @override
  _DashBoardStatusTabState createState() => _DashBoardStatusTabState();
}

class _DashBoardStatusTabState extends State<DashBoardStatusTab> {
  @override
...
class DashBoardDepositTab extends StatefulWidget {


  @override
  _DashBoardDepositTabState createState() => _DashBoardDepositTabState();
}

class _DashBoardDepositTabState extends State<DashBoardDepositTab> {
  @override
  Widget build(BuildContext context) {
    return DefaultTabController(
      length: 3,
