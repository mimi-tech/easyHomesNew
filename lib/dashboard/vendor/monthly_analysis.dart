...
class MonthlyBookingTransaction extends StatefulWidget {
  @override
  _MonthlyBookingTransactionState createState() => _MonthlyBookingTransactionState();
}

class _MonthlyBookingTransactionState extends State<MonthlyBookingTransaction> {
        ...
        body: CustomScrollView(slivers: <Widget>[
          SliverAppBar(
              ...
              flexibleSpace: TxnAmount(title:"This Month earnings".toUpperCase() ,
                ...
                amount:  DateTime.now().month ==   Constant1.workingDocuments![0]['mth']?'${VariablesOne.numberFormat.format(  Constant1.workingDocuments![0]['p4m']).toString()}':'0.00',
              )),
          SliverAppBar(
