...
class YearlyBookingTransaction extends StatefulWidget {
  @override
  _YearlyBookingTransactionState createState() => _YearlyBookingTransactionState();
}

class _YearlyBookingTransactionState extends State<YearlyBookingTransaction> {
        ...
        body: CustomScrollView(slivers: <Widget>[
          ...
          SliverAppBar(
              ...
              flexibleSpace: TxnAmount(title:"This Year earnings".toUpperCase() ,
                ...
                amount:  DateTime.now().year ==   Constant1.workingDocuments![0]['yr']?'${VariablesOne.numberFormat.format(  Constant1.workingDocuments![0]['p4y']).toString()}':'0.00',
              )),
          SliverAppBar(
