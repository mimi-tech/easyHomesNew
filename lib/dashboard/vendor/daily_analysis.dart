    ...
    stream: FirebaseFirestore.instance
      ...
      if (snapshot.connectionState == ConnectionState.waiting) {
        ...
        return workingDocuments.length == 0
            ? Center(child: Text('Sorry you have no earnings'))
            : ListView.builder(
                        ...
                        child: Column(
                          children: <Widget>[
                                  ...
                                  children: <Widget>[
                                    ...
                                    MoneyFormatColors(
                                      ...
                                      title: TextWidgetAlign(
                                        name: '${VariablesOne.numberFormat.format(workingDocuments[index]['p4y']).toString()}',
                            ...
                            EarningsConstruct(period: 'All ',
                              ...
                              title:'${VariablesOne.numberFormat.format(workingDocuments[index]['all'])}',
                              open: (){
                                Navigator.push(context, PageTransition(
                                    type: PageTransitionType.rightToLeft,
                                    child: AllBookingTransaction()));
                              },
                            ),

                            EarningsConstruct(period: kToday,
                            number: DateTime.now().day == workingDocuments[index]['day']?workingDocuments[index]['dai'].toString():'0',
                              title: DateTime.now().day == workingDocuments[index]['day']?'${VariablesOne.numberFormat.format(workingDocuments[index]['p4d']).toString()}':'0.00',
                            open: (){
                              Navigator.push(context, PageTransition(
                                  type: PageTransitionType.rightToLeft,
                            ...
                            number: Jiffy().week == workingDocuments[index]['wky']?workingDocuments[index]['wkb'].toString():'0',
                              title: Jiffy().week == workingDocuments[index]['wky']?'${VariablesOne.numberFormat.format(workingDocuments[index]['p4w']).toString()}':'0.00',
                              open: (){
                                Navigator.push(context, PageTransition(
                                    type: PageTransitionType.rightToLeft,
                            ...
                            EarningsConstruct(period: kMonthly,
                              ...
                              title: DateTime.now().month == workingDocuments[index]['mth']?'${VariablesOne.numberFormat.format(workingDocuments[index]['p4m']).toString()}':'0.00',
                              open: (){
                                Navigator.push(context, PageTransition(
                                    type: PageTransitionType.rightToLeft,
                            ...
                            EarningsConstruct(period: kYearly,
                              ...
                              title: DateTime.now().year == workingDocuments[index]['yr']?'${VariablesOne.numberFormat.format(workingDocuments[index]['p4y']).toString()}':'0.00',
