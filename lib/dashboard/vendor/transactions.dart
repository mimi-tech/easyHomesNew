...
class BookingTransaction extends StatefulWidget {
  @override
  _BookingTransactionState createState() => _BookingTransactionState();
}

class _BookingTransactionState extends State<BookingTransaction> {
        ...
        body: CustomScrollView(slivers: <Widget>[
          SliverAppBar(
              ...
              flexibleSpace: TxnAmount(title:"Today's earnings".toUpperCase() ,
                amount: DateTime.now().day ==    Constant1.workingDocuments![0]['day']?'${VariablesOne.numberFormat.format(  Constant1.workingDocuments![0]['p4d']).toString()}':'0.00',
