...
class DashBoardWithdrawalTab extends StatefulWidget {


  @override
  _DashBoardWithdrawalTabState createState() => _DashBoardWithdrawalTabState();
}

class _DashBoardWithdrawalTabState extends State<DashBoardWithdrawalTab> {
  @override
