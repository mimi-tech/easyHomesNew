...
class GeneralMessageScreen extends StatefulWidget {
  @override
  _GeneralMessageScreenState createState() => _GeneralMessageScreenState();
}
    ...
    return NotificationListener<ScrollNotification>(
        ...
        appBar: PlatformAppBar(
          ...
          title: Row(
            ...
            children: <Widget>[
              TextWidget(name: kMessage3.toUpperCase(),// AdminConstants.bizName!.toUpperCase(),
