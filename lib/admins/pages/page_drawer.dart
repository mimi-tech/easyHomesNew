                  ...
                  children: <Widget>[
                    Card(
                      ...
                      child: Column(
                        children: <Widget>[
                          TextWidget(
                            name: PageConstants.getVendorCount.length == 0?'0':

                            DateTime.now().day != PageConstants.getVendorCount[0]['day']?'0':
                            PageConstants.getVendorCount[0]['dai'].toString(),
                      ...
                      child: Column(
                        children: <Widget>[
                          TextWidget(
                            ...
                            Jiffy().week  != PageConstants.getVendorCount[0]['wky']?'0':
                            PageConstants.getVendorCount[0]['wkb'].toString(),
                      ...
                      child: Column(
                        children: <Widget>[
                          TextWidget(
                            ...
                            DateTime.now().month != PageConstants.getVendorCount[0]['mth']?'0':
                            PageConstants.getVendorCount[0]['mtb'].toString(),
                    ...
                    Card(
                      ...
                      child: Column(
                        children: <Widget>[
                          TextWidget(
                            name:   PageConstants.getVendorCount.length == 0?'0':
                            DateTime.now().year != PageConstants.getVendorCount[0]['yr']?'0':
                            PageConstants.getVendorCount[0]['yb'].toString(),
...
space(),
        ...
        GestureDetector(
          ...
          child: Row(
            ...
            children: <Widget>[
              TextWidget(
                name: '${kOrderHistory.toUpperCase()} (${ PageConstants.getVendorCount.length == 0?'0':PageConstants.getVendorCount[0]['yb'].toString()})',
                textColor: kWhiteColor,
                textSize: kFontSize14,
                textWeight: FontWeight.bold,
              ),
