...
class UsersSearchStream extends StatefulWidget {
  @override
  _UsersSearchStreamState createState() => _UsersSearchStreamState();
}

class _UsersSearchStreamState extends State<UsersSearchStream> {
  ...
  initiateSearch(value) {
    ...
    try{
      FirebaseFirestore.instance.collection('userReg')
          ...
          .orderBy('date',descending: true).limit(Variables.limit)
          ...
          child: Column(
            ...
            children: <Widget>[
              Row(
                ...
                children: <Widget>[
                  VendorPix(pix: itemsData[index]['pix'],
                    pixColor: Colors.transparent,),
                    ...
                    children: <Widget>[
                      ...
                      AdminConstants.category == AdminConstants.owner!.toLowerCase()
                        ...
                        MoneyFormatColors(
                          color: kSeaGreen,
                          title: TextWidget(
                            name: VariablesOne.numberFormat.format(
                                itemsData[index]['wal']).toString(),
                            textColor: kSeaGreen,
                            textSize: kFontSize14,
                            textWeight: FontWeight.w500,
                          ),
