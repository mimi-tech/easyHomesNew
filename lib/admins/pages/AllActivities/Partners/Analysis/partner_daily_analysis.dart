...
class PartnerDailyAnalysisPage extends StatefulWidget {
  @override
  _PartnerDailyAnalysisPageState createState() => _PartnerDailyAnalysisPageState();
}

class _PartnerDailyAnalysisPageState extends State<PartnerDailyAnalysisPage> {
