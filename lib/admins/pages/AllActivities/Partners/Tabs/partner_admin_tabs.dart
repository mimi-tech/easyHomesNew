...
import 'package:easy_homes/admins/pages/AllActivities/Partners/Activities/sales_girls.dart';
...
class PartnerAdminLogTab extends StatefulWidget {
  PartnerAdminLogTab({
  ...
  @override
  _PartnerAdminLogTabState createState() => _PartnerAdminLogTabState();
}

class _PartnerAdminLogTabState extends State<PartnerAdminLogTab> {
  Widget space() {
        ...
        children: <Widget>[
          ...
          Row(
            ...
            children: <Widget>[
              ...
              GestureDetector(
                onTap: (){
                  Navigator.push(context, PageTransition(type: PageTransitionType.rightToLeft, child: ShowPartnerAdmins()));
              ...
              GestureDetector(
                onTap: (){
                  Navigator.push(context, PageTransition(type: PageTransitionType.rightToLeft, child: PartnerSalesGirls()));
