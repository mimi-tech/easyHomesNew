...
class ShowPartnerAdmins extends StatefulWidget {
  @override
  _ShowPartnerAdminsState createState() => _ShowPartnerAdminsState();
}

class _ShowPartnerAdminsState extends State<ShowPartnerAdmins> {
  Widget space() {
