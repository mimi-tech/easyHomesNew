...
class PartnerOnlineVendors extends StatefulWidget {
  @override
  _PartnerOnlineVendorsState createState() => _PartnerOnlineVendorsState();
}

class _PartnerOnlineVendorsState extends State<PartnerOnlineVendors> {
  Widget space() {
  ...
  void getOnline() {
    setState(() {
      ...
      onlineVendors.clear();
      onlineVendors = PageConstants.vendorCount.where((element) => element['ol'] == true ).toList();
