...
class PartnerScheduledScreen extends StatefulWidget {
  @override
  _PartnerScheduledScreenState createState() => _PartnerScheduledScreenState();
}

class _PartnerScheduledScreenState extends State<PartnerScheduledScreen> {
  Widget space() {
  ...
  Widget build(BuildContext context) {
    return AnimatedPadding(
        ...
        child: Container(
          ...
          NoWorkError(title: '$kSheError for ${AdminConstants.bizName}')
              : SingleChildScrollView(
              child: Column(
                children: <Widget>[

                  StickyHeader(
                    header:  AdminHeader(title: '$kShe for ${AdminConstants.bizName}',),
  ...
  void getOnline() {
    setState(() {
      ...
      onlineVendors.clear();
      onlineVendors = PageConstants.vendorCount.where((element) => element['tr'] == true ).toList();
