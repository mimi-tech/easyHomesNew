...
class PartnerSalesGirls extends StatefulWidget {
  @override
  _PartnerSalesGirlsState createState() => _PartnerSalesGirlsState();
}

class _PartnerSalesGirlsState extends State<PartnerSalesGirls> {
  Widget space() {
