...
class PartnerComYearlyAnalysisPage extends StatefulWidget {
  @override
  _PartnerComYearlyAnalysisPageState createState() =>
      _PartnerComYearlyAnalysisPageState();
}

class _PartnerComYearlyAnalysisPageState extends State<PartnerComYearlyAnalysisPage> {
  dynamic sum = 0;
  var amount = <dynamic>[];
  var count = <dynamic>[];
  dynamic counting = 0;
