...
class PartnerComWeeklyAnalysisPage extends StatefulWidget {
  @override
  _PartnerComWeeklyAnalysisPageState createState() =>
      _PartnerComWeeklyAnalysisPageState();
}

class _PartnerComWeeklyAnalysisPageState extends State<PartnerComWeeklyAnalysisPage> {
  dynamic sum = 0;
  var amount = <dynamic>[];
  var count = <dynamic>[];
  dynamic counting = 0;
        ...
        child: Scaffold(
            ...
            body: CustomScrollView(slivers: <Widget>[
              ...
              SliverAppBar(
                ...
                bottom: PreferredSize(
                  preferredSize: Size.fromHeight(
                      MediaQuery.of(context).size.height * kSliverHeight2),
                  child: Column(
