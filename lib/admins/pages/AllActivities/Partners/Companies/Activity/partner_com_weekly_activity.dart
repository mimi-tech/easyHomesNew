...
class PartnerComActivitiesPageWeekly extends StatefulWidget {
  @override
  _PartnerComActivitiesPageWeeklyState createState() => _PartnerComActivitiesPageWeeklyState();
}

class _PartnerComActivitiesPageWeeklyState extends State<PartnerComActivitiesPageWeekly> {
  dynamic sum = 0;
  var amount = <dynamic>[];
                  ...
                  delegate: SliverChildListDelegate([
                    Column(
                      children: <Widget>[
                        ...
                        itemsData.length == 0 && progress == true ? ErrorTitle(errorTitle:'$kNoVendorWeek for  ${PageConstants.companyName }'):
                        ListView.builder(
