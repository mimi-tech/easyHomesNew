...
class PartnerComVendorLogs extends StatefulWidget {
  @override
  _PartnerComVendorLogsState createState() => _PartnerComVendorLogsState();
}

class _PartnerComVendorLogsState extends State<PartnerComVendorLogs> {
  Widget space() {
          ...
          child: SingleChildScrollView(
              child: Column(
                  children: <Widget>[
                    ...
                    itemsData.length == 0?TextWidgetAlign(
                      name:'$kVendorNotWork',
  ...
  void getCompanyVendors() {
    ...
    setState(() {
      itemsData = PageConstants.filteredCompanyVendors.where((element) => element['vid'] == PageConstants.vendorID).toList();
