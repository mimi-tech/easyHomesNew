...
import 'package:easy_homes/admins/pages/AllActivities/Partners/Companies/Analysis/partner_com_monthly_analysis.dart';
import 'package:easy_homes/admins/pages/AllActivities/Partners/Companies/Analysis/partner_com_weekly_analysis.dart';
import 'package:easy_homes/admins/pages/AllActivities/Partners/Companies/Analysis/partner_com_yearly_analysis.dart';
...
class PartnerComAnalysisTab extends StatelessWidget {
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  GestureDetector(
                      onTap: (){
                        Navigator.pop(context);
                        Navigator.push(context, PageTransition(type: PageTransitionType.rightToLeft, child: PartnerComWeeklyAnalysisPage()));
                  ...
                  GestureDetector(
                      onTap: (){
                        Navigator.pop(context);
                        Navigator.push(context, PageTransition(type: PageTransitionType.rightToLeft, child: PartnerComMonthlyAnalysisPage()));
                  ...
                  GestureDetector(
                      onTap: (){
                        Navigator.pop(context);
                        Navigator.push(context, PageTransition(type: PageTransitionType.rightToLeft, child: PartnerComYearlyAnalysisPage()));
