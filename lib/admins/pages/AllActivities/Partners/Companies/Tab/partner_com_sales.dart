...
class PartnerComSalesGirls extends StatefulWidget {
  @override
  _PartnerComSalesGirlsState createState() => _PartnerComSalesGirlsState();
}

class _PartnerComSalesGirlsState extends State<PartnerComSalesGirls> {
  Widget space() {
    ...
    return  Column(
      children: <Widget>[
        ...
        SalesLogs(image: PageConstants.sectaries[index]['pix'],
            ...
            bizCodes: PageConstants.sectaries[index]['sac'],
