...
class EasyRemovedVendor extends StatefulWidget {
  @override
  _EasyRemovedVendorState createState() => _EasyRemovedVendorState();
}

class _EasyRemovedVendorState extends State<EasyRemovedVendor> {
  Widget space() {
...
bool _publishModal = false;
    ...
    return SafeArea(
        child: Scaffold(
            ...
            appBar:CancelAppBar(
              ...
              title: 'Removed vendors'.toUpperCase(),),
                ...
                delegate: SliverChildListDelegate([
                        ...
                        space(),
                          itemsData.length == 0 && progress == false
                              ...
                              ? ErrorTitle(errorTitle: kReAdmitError.toString(),)
                              : ListView.builder(
  ...
  Future<void> getComments() async {
    final QuerySnapshot result = await FirebaseFirestore.instance
        ...
        .collectionGroup("companyVendors").where('appr',isEqualTo: false).where('re',isEqualTo: true)
