...
class EasyOnlineVendors extends StatefulWidget {
  @override
  _EasyOnlineVendorsState createState() => _EasyOnlineVendorsState();
}

class _EasyOnlineVendorsState extends State<EasyOnlineVendors> {
  Widget space() {
  ...
  void getOnline() {
    try{
      stream = FirebaseFirestore.instance.collectionGroup('companyVendors')
  ...
  void getDetails(int index) {
    setState(() {
      ...
      PageConstants.getVendor =
          PageConstants.vendorCount.where((element) => element['vId'] ==
              onlineVendors[index]['vId']).toList();

      PageConstants.getVendorCount =
          PageConstants.allVendorCount.where((element) => element['vid'] ==
              onlineVendors[index]['vId']).toList();
    });
