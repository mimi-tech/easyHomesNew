...
class EasyComment extends StatefulWidget {
  @override
  _EasyCommentState createState() => _EasyCommentState();
}

class _EasyCommentState extends State<EasyComment> {
  Widget space() {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        ...
        appBar:SearchBottomAdminAppBar(title: 'Comment'.toUpperCase(),),
