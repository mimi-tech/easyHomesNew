...
class EasySalesGirls extends StatefulWidget {
  @override
  _EasySalesGirlsState createState() => _EasySalesGirlsState();
}

class _EasySalesGirlsState extends State<EasySalesGirls> {
  Widget space() {
                    ...
                    slivers: <Widget>[
                      ...
                      SliverList(
                        delegate: SliverChildListDelegate([
                          ...
                          ErrorTitle(errorTitle:'No sales personnel yet') :
  ...
  Future<void> getAdmins() async {
    ...
    .where('sa', isEqualTo: true).orderBy('ts',descending: true).get();
