      ...
      child: Padding(
        ...
        child: Column(
          ...
          Divider(),
            ...
            TextWidget(
              name: '${workingDocuments[index]['str']}'.toUpperCase(),
              textColor: kTextColor,
              textSize: kFontSize14,
              textWeight: FontWeight.w500,
            ),
              ...
              IconButton(
                ...
                onPressed: () {
                  Navigator.of(context).push
                    (MaterialPageRoute(
                      builder: (context) => VendorDocument(doc:_documents[index])));
                  ...
                  SliverList(
                    delegate: SliverChildListDelegate([
                      ...
                      workingDocuments.length == 0 && progress == false
                          ...
                          ? ErrorTitle(errorTitle:"There is no vendor")
                          : ListView.builder(
                          ...
                          itemBuilder: (context, int index) {
                            ...
                            '${workingDocuments[index]['fn']}'.toLowerCase()
...
('userReg').doc(PageConstants.vendorCount[index]['ud']).set({
        'bl':true
