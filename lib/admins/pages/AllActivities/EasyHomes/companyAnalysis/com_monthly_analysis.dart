...
class CompanyMonthlyAnalysisPage extends StatefulWidget {
  @override
  _CompanyMonthlyAnalysisPageState createState() =>
      _CompanyMonthlyAnalysisPageState();
}

class _CompanyMonthlyAnalysisPageState extends State<CompanyMonthlyAnalysisPage> {
  dynamic sum = 0;
  var amount = <dynamic>[];
  var count = <dynamic>[];
  dynamic counting = 0;
