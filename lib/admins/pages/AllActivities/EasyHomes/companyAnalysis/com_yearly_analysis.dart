...
class CompanyYearlyAnalysisPage extends StatefulWidget {
  @override
  _CompanyYearlyAnalysisPageState createState() =>
      _CompanyYearlyAnalysisPageState();
}

class _CompanyYearlyAnalysisPageState extends State<CompanyYearlyAnalysisPage> {
  dynamic sum = 0;
  var amount = <dynamic>[];
  var count = <dynamic>[];
  dynamic counting = 0;
