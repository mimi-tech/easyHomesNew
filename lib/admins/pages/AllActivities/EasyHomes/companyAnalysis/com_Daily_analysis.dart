...
class CompanyDailyAnalysisPage extends StatefulWidget {
  @override
  _CompanyDailyAnalysisPageState createState() =>
      _CompanyDailyAnalysisPageState();
}

class _CompanyDailyAnalysisPageState extends State<CompanyDailyAnalysisPage> {
  dynamic sum = 0;
  var amount = <dynamic>[];
  var count = <dynamic>[];
  dynamic counting = 0;
