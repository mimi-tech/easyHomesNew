...
class CompanyWeeklyAnalysisPage extends StatefulWidget {
  @override
  _CompanyWeeklyAnalysisPageState createState() =>
      _CompanyWeeklyAnalysisPageState();
}

class _CompanyWeeklyAnalysisPageState extends State<CompanyWeeklyAnalysisPage> {
  dynamic sum = 0;
  var amount = <dynamic>[];
  var count = <dynamic>[];
  dynamic counting = 0;
              ...
              SliverAppBar(
                  ...
                  bottom: PreferredSize(
                    preferredSize: Size.fromHeight(
                        MediaQuery.of(context).size.height * kSliverAppHeight),
                    child: Text('')
                  ),
                                      ...
                                      child: Container(
                                        ...
                                        child: Row(
                                          ...
                                          children: <Widget>[
                                            ...
                                            AdminAmount(oAmount: itemsData[index]['amo'],
...
.collectionGroup("CountSW")
        .where('id',isEqualTo:  PageConstants.companyUD)
        .orderBy('wk', descending: true).limit(Variables.limit)
        .get();
