...
class VendorActivitiesPageMonthly extends StatefulWidget {
  @override
  _VendorActivitiesPageMonthlyState createState() => _VendorActivitiesPageMonthlyState();
}

class _VendorActivitiesPageMonthlyState extends State<VendorActivitiesPageMonthly> {
