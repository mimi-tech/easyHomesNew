...
class VendorActivitiesPageWeekly extends StatefulWidget {
  @override
  _VendorActivitiesPageWeeklyState createState() => _VendorActivitiesPageWeeklyState();
}

class _VendorActivitiesPageWeeklyState extends State<VendorActivitiesPageWeekly> {
