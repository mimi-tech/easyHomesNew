...
class CompanyActivitiesPageWeekly extends StatefulWidget {
  @override
  _CompanyActivitiesPageWeeklyState createState() => _CompanyActivitiesPageWeeklyState();
}

class _CompanyActivitiesPageWeeklyState extends State<CompanyActivitiesPageWeekly> {
  dynamic sum = 0;
  var amount = <dynamic>[];
