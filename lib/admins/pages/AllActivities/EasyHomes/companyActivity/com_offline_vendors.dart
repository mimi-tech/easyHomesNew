...
class EasyComOffLineVendors extends StatefulWidget {
  @override
  _EasyComOffLineVendorsState createState() => _EasyComOffLineVendorsState();
}

class _EasyComOffLineVendorsState extends State<EasyComOffLineVendors> {
  Widget space() {
        ...
        child: SingleChildScrollView(
            child: Container(
                height: MediaQuery.of(context).size.height * kModalHeight,
                  ...
                  NoWorkError(title: '$kOffError for ${PageConstants.companyName}',)
                      : SingleChildScrollView(
                    child: Column(
                      children: <Widget>[

                    StickyHeader(
                    header:  AdminHeader(title: '$kOff2 for ${PageConstants.companyName}',),
  ...
  void getOnline() {
    setState(() {
      ...
      onlineVendors.clear();
      onlineVendors = PageConstants.vendorCount.where((element) => element['ol'] == false && element['id'] == PageConstants.companyUD ).toList();
