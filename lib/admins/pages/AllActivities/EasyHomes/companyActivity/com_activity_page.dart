...
class CompanyActivitiesPage extends StatefulWidget {
  @override
  _CompanyActivitiesPageState createState() => _CompanyActivitiesPageState();
}

class _CompanyActivitiesPageState extends State<CompanyActivitiesPage> {
  dynamic sum = 0;
  var amount = <dynamic>[];
