...
class CompanyActivitiesPageMonthly extends StatefulWidget {
  @override
  _CompanyActivitiesPageMonthlyState createState() => _CompanyActivitiesPageMonthlyState();
}

class _CompanyActivitiesPageMonthlyState extends State<CompanyActivitiesPageMonthly> {
  dynamic sum = 0;
  var amount = <dynamic>[];
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(child: Scaffold(
        ...
        bottomNavigationBar: TotalAmount(day:'$kThisMth ',name: sum <=  0?'0':'#${sum.toString()}',),
