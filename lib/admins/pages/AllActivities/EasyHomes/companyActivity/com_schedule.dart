...
class CompanyScheduledScreen extends StatefulWidget {
  @override
  _CompanyScheduledScreenState createState() => _CompanyScheduledScreenState();
}

class _CompanyScheduledScreenState extends State<CompanyScheduledScreen> {
  String? filter;
  @override
  void initState() {
      ...
      child: AnimatedPadding(
        ...
        child: Container(
          ...
          child:itemsData.length == 0 && _itemLength == false
              ...
              ? NoOnGoing(title: 'Sorry there is no ongoing order for ${PageConstants.companyName}',)
