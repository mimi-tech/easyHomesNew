...
class CompanySec extends StatefulWidget {
  @override
  _CompanySecState createState() => _CompanySecState();
}

class _CompanySecState extends State<CompanySec> {
  Widget space() {
...
if (documents.length == 0) {
  ...
  Future<void> removeAdmin(int index) async {
    try{
      ...
      await FirebaseFirestore.instance.collection('userReg').doc(PageConstants.sectaries[index]['ud']).update({
