...
class CompanyActivitiesPageYear extends StatefulWidget {
  @override
  _CompanyActivitiesPageYearState createState() => _CompanyActivitiesPageYearState();
}

class _CompanyActivitiesPageYearState extends State<CompanyActivitiesPageYear> {
  dynamic sum = 0;
  var amount = <dynamic>[];
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(child: Scaffold(
        ...
        bottomNavigationBar: TotalAmount(day:'$kThisYear ',name: sum <=  0?'0':'#${sum.toString()}',),
                  ...
                  bottom: PreferredSize(
                    ...
                    child:Column(
                      children: <Widget>[
                        ...
                        space(),
                        CompanyCountTab(
  counting: PageConstants.companyVendorCount.toString(),
