...
class CompanyDailyAnalysis extends StatefulWidget {
  @override
  _CompanyDailyAnalysisState createState() => _CompanyDailyAnalysisState();
}

class _CompanyDailyAnalysisState extends State<CompanyDailyAnalysis> {
  Widget space() {
  ...
  void requestNextPage() async {
    if (!_isRequesting && !_isFinish) {
      ...
      if (_products.isEmpty) {
        querySnapshot = await FirebaseFirestore.instance.collection('vendorDaily')
            .where('gd', isEqualTo:  PageConstants.companyUD )
            .orderBy('dt',descending: false)
