...
class StationYearlyAnalysisPage extends StatefulWidget {
  @override
  _StationYearlyAnalysisPageState createState() => _StationYearlyAnalysisPageState();
}

class _StationYearlyAnalysisPageState extends State<StationYearlyAnalysisPage> {
