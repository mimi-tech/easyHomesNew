...
class StationDailyAnalysisPage extends StatefulWidget {
  @override
  _StationDailyAnalysisPageState createState() => _StationDailyAnalysisPageState();
}

class _StationDailyAnalysisPageState extends State<StationDailyAnalysisPage> {
...
//                    BizVendorsTabs(),
  ...
  Future<void> getData() async {
    final QuerySnapshot result = await FirebaseFirestore.instance.collectionGroup("countSD")
