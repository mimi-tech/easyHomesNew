...
class StationMonthlyAnalysisPage extends StatefulWidget {
  @override
  _StationMonthlyAnalysisPageState createState() => _StationMonthlyAnalysisPageState();
}

class _StationMonthlyAnalysisPageState extends State<StationMonthlyAnalysisPage> {
...
//                    BizVendorsTabs(),
                                    ...
                                    Padding(
                                      ...
                                      child: Container(
                                        ...
                                        child: Row(
                                          ...
                                          children: <Widget>[
                                            AdminDateBookings( date:'${DateFormat('MMM').format(DateTime.parse(itemsData[index]['dt']))}',),
  ...
  Future<void> getData() async {
    final QuerySnapshot result = await FirebaseFirestore.instance.collectionGroup("CountSM")
