...
class BizYearlyAnalysisPage extends StatefulWidget {
  @override
  _BizYearlyAnalysisPageState createState() => _BizYearlyAnalysisPageState();
}

class _BizYearlyAnalysisPageState extends State<BizYearlyAnalysisPage> {
