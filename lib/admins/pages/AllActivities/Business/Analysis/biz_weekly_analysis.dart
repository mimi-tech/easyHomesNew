...
class BizWeeklyAnalysisPage extends StatefulWidget {
  @override
  _BizWeeklyAnalysisPageState createState() => _BizWeeklyAnalysisPageState();
}

class _BizWeeklyAnalysisPageState extends State<BizWeeklyAnalysisPage> {
...
counting: PageConstants.vendorNumber.toString(),
  ...
  Future<void> getData() async {
    final QuerySnapshot result = await FirebaseFirestore.instance.collectionGroup("countBW")
