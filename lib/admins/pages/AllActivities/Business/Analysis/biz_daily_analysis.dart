...
class BizDailyAnalysisPage extends StatefulWidget {
  @override
  _BizDailyAnalysisPageState createState() => _BizDailyAnalysisPageState();
}

class _BizDailyAnalysisPageState extends State<BizDailyAnalysisPage> {
  ...
  Future<void> getData() async {
    final QuerySnapshot result = await FirebaseFirestore.instance.collectionGroup("countBD")
        .where('id',isEqualTo: Variables.userUid)
