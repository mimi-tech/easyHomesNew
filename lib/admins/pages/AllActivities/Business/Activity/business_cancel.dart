...
class BusinessCancelOrder extends StatefulWidget {
  @override
  _BusinessCancelOrderState createState() => _BusinessCancelOrderState();
}

class _BusinessCancelOrderState extends State<BusinessCancelOrder> {
  Widget space() {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
        child: Scaffold(
          ...
          appBar:SearchBottomAdminAppBar(title: kCancelOrder.toUpperCase(),),
