...
class BizActivitiesPageMonthly extends StatefulWidget {
  @override
  _BizActivitiesPageMonthlyState createState() => _BizActivitiesPageMonthlyState();
}

class _BizActivitiesPageMonthlyState extends State<BizActivitiesPageMonthly> {
  ...
  Future<void> getData() async {
    final QuerySnapshot result = await FirebaseFirestore.instance.collection("vendorDaily")
