...
class BizAdminLogs extends StatefulWidget {
  @override
  _BizAdminLogsState createState() => _BizAdminLogsState();
}

class _BizAdminLogsState extends State<BizAdminLogs> {
  Widget space() {
