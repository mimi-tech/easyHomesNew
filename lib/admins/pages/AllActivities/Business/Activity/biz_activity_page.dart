...
class BizActivitiesPage extends StatefulWidget {
  @override
  _BizActivitiesPageState createState() => _BizActivitiesPageState();
}

class _BizActivitiesPageState extends State<BizActivitiesPage> {
    ...
    if(documents.length == 0){
      ...
      for (DocumentSnapshot document in documents) {
        ...
        setState(() {
          ...
          sum += data['amt'];
          amount.add(data['amt']);
          //sum = amount.fold(0, (previous, current) => current + previous);
