...
class BizOnlineVendors extends StatefulWidget {
  @override
  _BizOnlineVendorsState createState() => _BizOnlineVendorsState();
}

class _BizOnlineVendorsState extends State<BizOnlineVendors> {
  Widget space() {
    ...
    return AnimatedPadding(
        ...
        child: SingleChildScrollView(
          ...
          child: Container(
              ...
              NoOnGoing(title: '$kOlError2 for ${AdminConstants.bizName}',)
                  : SingleChildScrollView(
                child: Column(
                  children: <Widget>[

                StickyHeader(
                header:  AdminHeader(title: '$kOl3 for ${AdminConstants.bizName}',),
                ...
                content: ListView.builder(
                    ...
                    itemBuilder: (context, int index) {
                      ...
                      children: <Widget>[
                            Row(
                              children: <Widget>[
                                VendorPix(pix:onlineVendors[index]['pix'] ,pixColor: Colors.transparent,),
  ...
  void getOnline() {
    setState(() {
      ...
      onlineVendors.clear();
      onlineVendors = PageConstants.vendorCount.where((element) => element['ol'] == true && element['ud'] == Variables.userUid  ).toList();
