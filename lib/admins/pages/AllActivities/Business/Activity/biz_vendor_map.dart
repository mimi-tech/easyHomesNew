...
class BizVendorMap extends StatefulWidget {
  BizVendorMap({required this.index});

  final int index;
  @override
  _BizVendorMapState createState() => _BizVendorMapState();
}

class _BizVendorMapState extends State<BizVendorMap> {
...
bool progress = true;
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            GestureDetector(
                              onTap:() async {
                                var url = "tel:${PageConstants.vendorCount[widget.index]['ph']}";
                              ...
                              child: TextWidget(
                                name:  PageConstants.vendorCount[widget.index]['ph'],
                                textColor: kDoneColor,
                                textSize: kFontSize,
                                textWeight: FontWeight.w500,
                              ),
  ...
  Future<void> getVendorLocation() async {
