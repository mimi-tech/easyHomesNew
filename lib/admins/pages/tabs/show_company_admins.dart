...
class ShowCompanyAdmins extends StatefulWidget {
  @override
  _ShowCompanyAdminsState createState() => _ShowCompanyAdminsState();
}

class _ShowCompanyAdminsState extends State<ShowCompanyAdmins> {
  Widget space() {
