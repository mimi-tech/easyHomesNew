...
class AdminLogTab extends StatefulWidget {
  ...
  @override
  _AdminLogTabState createState() => _AdminLogTabState();
}
        ...
        children: <Widget>[
          ...
          Row(
            ...
            children: <Widget>[
              ...
              GestureDetector(
                onTap: (){
                  Navigator.push(context, PageTransition(type: PageTransitionType.rightToLeft, child: EasySalesGirls()));
...
class AdminLogTabCompany extends StatefulWidget {
  AdminLogTabCompany({
  ...
  @override
  _AdminLogTabCompanyState createState() => _AdminLogTabCompanyState();
}

class _AdminLogTabCompanyState extends State<AdminLogTabCompany> {
  Widget space() {
    return SizedBox(height: MediaQuery.of(context).size.height * 0.02);
  }
        ...
        children: <Widget>[
          ...
          Row(
            ...
            children: <Widget>[
              ...
              GestureDetector(
                onTap: (){
                  Navigator.push(context, PageTransition(type: PageTransitionType.rightToLeft, child: CompanySec()));

                },
                child: TextWidget(
                  name: 'All secretaries'.toUpperCase(),
                  textColor: widget.secColor,
                  textSize: 14,
                  textWeight: FontWeight.bold,
                ),
              ...
              GestureDetector(
                onTap: (){
                  Navigator.push(context, PageTransition(type: PageTransitionType.rightToLeft, child: ComSalesGirls()));
