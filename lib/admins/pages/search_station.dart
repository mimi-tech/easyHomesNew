...
class StationSearchStream extends StatefulWidget {
  @override
  _StationSearchStreamState createState() => _StationSearchStreamState();
}

class _StationSearchStreamState extends State<StationSearchStream> {
  ...
  Future<void> loadMore() async {
    ...
    try {
      FirebaseFirestore.instance.collectionGroup('AllBusiness')
          .where('sk', isEqualTo: capitalizedValue)
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(child: Scaffold(
        appBar: AppBar(
          ...
          title: Text('Search for a station',
  ...
  void minusWallet(int index) {
    ...
    if((Deposit.amount == null) || (Deposit.amount == 0)){
      ...
      try{
        ...
        FirebaseFirestore.instance
            .collection('AllBusiness').doc(itemsData[index]['id']).get()
            .then((resultEarnings) {
