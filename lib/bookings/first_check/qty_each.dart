...
class QuantityEach extends StatefulWidget {
  QuantityEach({ required this.title});

  final String title;
  @override
  _QuantityEachState createState() => _QuantityEachState();
}

class _QuantityEachState extends State<QuantityEach> {
  Widget spacer() {
