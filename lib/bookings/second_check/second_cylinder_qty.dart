...
class SecondCylinderQuantity extends StatefulWidget {

  @override
  _SecondCylinderQuantityState createState() => _SecondCylinderQuantityState();
}

class _SecondCylinderQuantityState extends State<SecondCylinderQuantity> {
  Widget spacer() {
