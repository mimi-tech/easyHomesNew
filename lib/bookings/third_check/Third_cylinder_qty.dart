...
class ThirdCylinderQuantity extends StatefulWidget {

  @override
  _ThirdCylinderQuantityState createState() => _ThirdCylinderQuantityState();
}

class _ThirdCylinderQuantityState extends State<ThirdCylinderQuantity> {
  Widget spacer() {
