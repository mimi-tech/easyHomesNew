...
class ThirdEstimate extends StatefulWidget {
  @override
  _ThirdEstimateState createState() => _ThirdEstimateState();
}

class _ThirdEstimateState extends State<ThirdEstimate> {
  Widget spacer() {
    ...
    return SafeArea(
        ...
        child: Scaffold(
            ...
            body: SingleChildScrollView(
              child: Column(
                children: [
                  EstimateConstruct(title:kEstimate3, size: '', kgTotal: '',),
