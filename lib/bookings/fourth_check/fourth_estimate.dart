...
class FourthEstimate extends StatefulWidget {
  @override
  _FourthEstimateState createState() => _FourthEstimateState();
}

class _FourthEstimateState extends State<FourthEstimate> {
  Widget spacer() {
