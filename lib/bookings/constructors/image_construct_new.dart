...
class NewCylinderQuantityConstruct extends StatefulWidget {
  NewCylinderQuantityConstruct({required this.qty,required this.title});
  final int qty;
  final String title;

  @override
  _NewCylinderQuantityConstructState createState() => _NewCylinderQuantityConstructState();
}

class _NewCylinderQuantityConstructState extends State<NewCylinderQuantityConstruct> with TickerProviderStateMixin {
    ...
    return Column(
      children: [
        ...
        SlideTransition(
          ...
          child: TextWidgetAlign(
            name: 'What is your cylinder size ?'.toUpperCase(),
            textColor: kTextColor,
            textSize: kFontSize,
