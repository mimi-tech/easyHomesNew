...
class _RateVendorState extends State<RateVendor> {
  ...
  TextEditingController _report = TextEditingController();
   Color bg1 = Colors.transparent;
   Color bg2 = Colors.transparent;
   Color bg3 = Colors.transparent;
double rate = 1.0;
bool show = false;
String? report;
bool progress = false;
        ...
        body: WillPopScope(
          ...
          child: SingleChildScrollView(
            ...
            itemsData.length == 0 && _publishModal == true ? ErrorTitle(errorTitle:'No rating for this vendor'):Container(
             ...
             VendorPix(pix: Variables.vendorRating!['vpi'], pixColor: Colors.transparent),
               ...
               rate = rating;
                  ...
                  RichText(
                    ...
                    text: TextSpan(
                        ...
                        children: <TextSpan>[
                          TextSpan(
                            text: Variables.vendorRating!['vfn'],
                            style:GoogleFonts.oxanium(
...
('comments')
      ...
      'ln': Variables.userLN,
       ...
       'cbi': Variables.vendorRating!['cbi'],
        'vfn': Variables.vendorRating!['vfn'],
        'vln': Variables.vendorRating!['vln'],
        'vpix':Variables.vendorRating!['vpi'],
        'vph':Variables.vendorRating!['vph'],
      'vid':Variables.vendorRating!['vid'],
